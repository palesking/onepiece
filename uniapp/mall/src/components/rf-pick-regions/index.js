/* eslint-disable */
// import { provinceList } from '@/service/basic';
export default {
	props: {
		// defaultRegions: {
		//     type: Array,
	...
	methods: {
		async getProvinceList() {
			...
			let city_name = null;
			let area_name = null;
			await this.$http.get('/tiny-shop/v1/common/provinces/index').then(async r => {
				...
				await 
				this.$http
				.get('/tiny-shop/v1/common/provinces/index', {
		...
		async bindMultiPickerColumnChange(e) {
			...
			switch (e.detail.column) {
				case 0: //拖动第1列
                    ...
                    await 
                    this.$http.get('/tiny-shop/v1/common/provinces/index', {
