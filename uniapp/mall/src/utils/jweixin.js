    !function (e, n) {
        ...
        ? module.exports = n(e) : 'function' === typeof define && (define.amd || define.cmd) 
        ? define(function () { return n(e) }) : n(e, !0)
    }(window, function (o, e) {
        function c(n, e, i) {
        ...
        function a(e, n, i) {
            ...
            delete i._complete), t = n.errMsg || '', M.debug && !i.isInnerInvoke && alert(JSON.stringify(n));
                let o = t.indexOf(':');
        ...
        if (!o.jWeixin) {
            var p = {
                ...
                k = {initStartTime: l(), initEndTime: 0, preVerifyStartTime: 0, preVerifyEndTime: 0}, 
                T = {
                    version: 1,
                    appId: '',
                    initTime: 0,
