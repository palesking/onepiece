		...
		return new Promise((resolve, reject) => {
			...
			const requestTask = uni.request({
				...
				complete: response => {
					...
					// 	const apiurl = "/" + api.split("/")[api.split("/").length - 1];
					// 	const data = response.data;
					// 	const params = options.params;

					// 	console.groupCollapsed("%c" + apiurl, "color: MediumVioletRed");
					// 	console.log("%c参数⬆︎:", "color: blue", params);
					// 	console.log("%c返回⬇︎:", "color: green", data);
					// 	console.groupEnd();
					// }
