...
export default {
	...
	async wxConfigH5(url) {
		if (this.isWechat()) {
			...
			await http
            .post('/tiny-shop/v1/third-party/wechat-js-sdk', {
                url: url,
	...
	async weixinPay(order_group, data, route = '/pages/user/money/success', code) {
		...
		// #ifdef APP-PLUS
		await http
        .post('/tiny-shop/v1/common/pay/create', {
            order_group,
            pay_type: 1,
            trade_type: 'app',
            data
		...
		// #ifndef APP-PLUS
		await http
        .post('/tiny-shop/v1/member/auth/is-binding', {
            // #ifdef H5
            oauth_client: 'wechat',
            // #endif
            // #ifdef MP-WEIXIN
            ...
            if (res.data.openid) {
                ...
                uni.login({
                    ...
                    success: function(loginRes) {
                        http.post(`'/tiny-shop/v1/common/pay/create'?code=${loginRes.code}`, {
                            order_group,
                            pay_type: 1,
                            trade_type: 'mini_program',
                            data
                ...
                // #ifdef H5
                await http
                .post(`'/tiny-shop/v1/common/pay/create'?code=${code}`, {
                    order_group,
                    pay_type: 1,
                    trade_type: 'js',
                    data
